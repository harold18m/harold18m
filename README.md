...
- Build **end-to-end web products** (frontend, backend, data).
- Develop **internal tools and dashboards** used by real users.
- Integrate **AI into products** (automation, content generation, vision-based flows).
- Work in fast-paced startup environments where execution matters.
...
**AI:** OpenAI APIs, RAG pipelines, automation workflows  
...
- 🌐 Website: https://h18m.tech  
- 💼 LinkedIn: https://linkedin.com/in/haroldmedrano18  
- 📧 Email: haroldmedrano33@gmail.com
